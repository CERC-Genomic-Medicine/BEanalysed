...
| `--Pick` | `False` | Use VEP's PICK flag (column `PICK`) to select [PICK](https://metazoa.ensembl.org/info/docs/tools/vep/script/vep_other.html#pick) (ensembl derived) isofrom derived annotations |
